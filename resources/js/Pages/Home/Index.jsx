    ...
    return (
        <Layout categories={categories}>
            <Head>
                ...
                <meta property="og:url" content={route('home')} head-key="og-url" />
                <meta property="og:title" content="Pakistan Today" head-key="og-title" />
                <meta property="og:description" content="The perfect place for entrepreneurs, mentors, and investors to connect, exchange ideas, and stay updated on industry news." head-key="og-description" />
                <meta property="og:image" content={route('favicon')} head-key="og-image" />

                <meta property="twitter:card" content="summary_large_image" head-key="twitter-card" />
                <meta property="twitter:url"  content={route('home')} head-key="twitter-url" />
